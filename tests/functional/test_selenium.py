...
pointsSymplyLift = driver.find_element(by=By.TAG_NAME, value="body > ul > li:nth-child(1)")
...
pointsSymplyLift = driver.find_element(by=By.TAG_NAME, value="body > ul:nth-child(6) > li:nth-child(1)")
print(pointsSymplyLift.text)
if int(numberOfPoints) - 4 < 0:
    assert pointsSymplyLift.text == f'Spring Festival\nDate: 2022-05-27 10:00:00\nNumber of Places: {int(numberOfPlaces)} Book Places'
else:
